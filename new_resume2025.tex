...
\cvitem{Book CChapters}{
\begin{itemize}
\item \textbf{Tilwani, D.}, Saxena, Y., Padia, A., Parthasarathy S., Gaur, M. (2026). Neurosymbolic AI for Legal AI-TRISM: Trustworthy, Reliable, Interpretable, Safe Models, In Neurosymbolic
AI,  \href{https://doi.org/10.1002/9781394302406.ch14}{Link}
\end{itemize}
}
\cvitem{Tutorials}{
\begin{itemize}
...
\cvitem{Posters}{
    \begin{itemize}
        \item Yang, X., \textbf{Tilwani, D.}, O’Reilly, C., \& Shinkareva, S. V. (2026). Revisitng the positivity effect: nonlinear age effects on valence perception across adulthood. Paper presented at the 2026 SAS Annual Conference.
...
\cvitem{Under Review}{
\begin{itemize}
    \item \textbf{Tilwani, D.}, Saxena, Y., Mohammadi, A., Raff, E., Sheth, A., Parthasarathy, S., \& Gaur, M. (2024). REASONS: A benchmark for REtrieval and Automated citationS Of scieNtific Sentences using Public and Proprietary LLMs. \textbf{(KDD 2026)}
    \item Yang, X., \textbf{Tilwani, D.}, O'Reilly, C, Shinkareva, S. Evaluating Large Language Models as Substitutes for Human Affective Ratings in Naturalistic Paradigms. Under Review in IEEE Transactions on Affective Computing.    
\end{itemize}
}

\section{Open Source Contributions}
\href{https://zenodo.org/records/18264033}{Dataset} REASONS: REtrieval and Automated citationS Of scieNtific Sentences (https://zenodo.org/records/18264033). 
...
\cvitem{}{
    \begin{itemize}
        \item 2025 Recipient of the 2025 University Travel Award for attendance at the International Conference on Advances in Signal Processing and Artificial Intelligence (ASPAI' 2025).
        \item 2025 AAAI-25 Student Scholarship Award  
        \item 2024 EMNLP Diversity and Inclusion Award 
        \item 2023 Trainee Best Research Presentation Winner, SCAND Symposium.
        \item 2023 Research Symposium Third Place Poster Award, University of South Carolina.
        \item 2021 Nirmala and Jashwantlal Clerk Memorial Scholarship, AIISC.
        \item 2020 2nd Prize, LINZ Ars Festival - BR41N.IO Hackathon.
        \item 2020 2nd Prize, BR41N.IO: Brain-Computer Interface Designers Hackathon.
